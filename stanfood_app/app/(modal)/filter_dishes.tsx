...
import categories from '@/assets/data/dishes_filter.json';
...
const STORAGE_KEY = '@dishes_filter_state';
...
const CategoryItem = React.memo(({ item, onToggle }: { item: Category; onToggle: (name: string) => void }) => (
  <Pressable
    style={({ pressed }) => [
      styles.itemRow,
      {
